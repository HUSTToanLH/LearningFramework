...
#define kFlickrAPIKey @"c28aadd3190ce524ff87485d48cf103f"
...
+ (NSString *)flickrPhotoURLForFlickrPhoto:(FlickrPhoto *) flickrPhoto size:(NSString *) size
{
    ...
    return [NSString stringWithFormat:@"http://farm%d.staticflickr.com/%d/%lld_%@_%@.jpg",(int)flickrPhoto.farm,(int)flickrPhoto.server,flickrPhoto.photoID,flickrPhoto.secret,size];
}
